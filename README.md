...
- [docs/figure1.svg](docs/figure1.svg) — the manuscript map figure referenced in the research note. Hand-authored from the Experiment 6/7 numbers, not generated by any script in `scripts/` — there's no one-command way to regenerate it from a fresh run.
